...
/**
 * Class Allegro_Web_Api_BidItemStruct
 * @package Allegro_Web_Api
 * @author Paweł Cieślik <cieslix@gmail.com>
 * @licence http://www.gnu.org/licenses/lgpl.html GNU Lesser General Public License, version 3 or later
 */
class Allegro_Web_Api_BidItemStruct extends Allegro_Web_Api_Abstract
{
    /**
     * @var int $itemId
     */
     ...
     */
    public function __construct($itemId, $itemTitle, $itemThumbnailUrl, $itemPrice, $itemBidQuantity, $itemLeftQuantity, $itemQuantityType, $itemEndTime, $itemEndTimeLeft, $itemSeller, $itemBiddersCounter, $itemHighestBidder, $itemCategoryId, $itemViewsCounter, $itemNote, $itemSpecialInfo, $itemShopInfo, $itemProductInfo, $itemPayuInfo)
    {
        $this->itemId             = $itemId;
